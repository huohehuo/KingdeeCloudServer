 ...
 * 条码打印
 */
@WebServlet(urlPatterns = "/PrintOutCheck4P2")
public class PrintOutCheck4P2 extends HttpServlet {
...
//                        bean.FWaveHouse   = rs.getString("生产单位ID");
                        ...
                        bean.FLevel   = rs.getString("等级");
                        bean.FYmLenght   = rs.getString("原木长");
                        bean.FYmDiameter   = rs.getString("原木直径");
                        bean.FBLenght   = rs.getString("板长");
                        bean.FBWide   = rs.getString("板宽");
                        bean.FBThick   = rs.getString("板厚");
                        bean.FVolume   = rs.getString("体积");
                        bean.FWidth   = rs.getString("FWidth");
                        bean.F_TypeID   = rs.getString("F_TypeID");
                        if ("1006703".equals(bean.F_TypeID)){
                            bean.FModel       = rs.getString("FAllGuiGe");
                        }else{
                            bean.FModel       = rs.getString("规格");
                        }
                        bean.F_Plies   = rs.getString("F_Plies");
                        bean.FCeng   = rs.getString("F_Plies");
