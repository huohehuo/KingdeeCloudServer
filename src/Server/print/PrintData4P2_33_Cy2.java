 ...
 * 条码检测（出库）
 */
@WebServlet("/PrintData4P2_33_Cy2")
public class PrintData4P2_33_Cy2 extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrintData4P2_33_Cy2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				Lg.e("PrintData4P2_33",parameter);
				DownloadReturnBean downloadReturnBean = new DownloadReturnBean();
				conn = JDBCUtil.getConn(request);
				sta = conn.prepareStatement("exec proc_PDABarCodeSign211_Insert2 ?");
