if (exists (select * from sys.objects where name = 'proc_PDABarCodeSign_Insert_NBCG'))
    drop proc proc_PDABarCodeSign_Insert_NBCG
go
create proc proc_PDABarCodeSign_Insert_NBCG
(
...
set @FBatchNo = dbo.getString(@mainStr,'|',10) --批号
