...
//                pushDownListBean.FSaleOrgID = rs.getString("销售组织ID");
                ...
                if (pushDownListRequestBean.id==1){
                ...
                if (pushDownListRequestBean.id==2 ||pushDownListRequestBean.id==21){
